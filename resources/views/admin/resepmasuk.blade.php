...
<body>
    <div class="w-full flex">
        ...
        <div class="bg-gradient-to-t from-cyan-500 to-[#1B4242] w-full">
            <h1 class="text-white font-bold text-2xl text-center py-10">RESEP MASUK</h1>
                    ...
                    @foreach ($resep as $key => $r)
                        <tr class="border">
                            ...
                            <td class="border py-10">
                                <a href="{{route('lihat',['model'=>'resepmasuk','id'=>$r->id])}}" class="bg-green-400 hover:bg-green-500 px-6 rounded-md py-2 text-white shadow-md mb-5 my-5">Lihat</a><br><br>
                                <a class="bg-yellow-400 hover:bg-yellow-500 px-5 rounded-md py-2 text-white shadow-md"
                                    href="{{ route('terima', $r->id) }}">Terima</a><br><br>

                                <a href="{{ route('tolak', $r->id) }}"
                                    class="bg-red-500 hover:bg-red-600 px-6 rounded-md py-2 text-white shadow-md">Tolak</a>
